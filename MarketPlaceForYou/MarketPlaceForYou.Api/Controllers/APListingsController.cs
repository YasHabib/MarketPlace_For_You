...
namespace MarketPlaceForYou.Api.Controllers
{
    ...
    {
        private readonly APListingService _apListingService;

        /// <summary>
        /// Constructor for AP listing controller
        /// </summary>
        /// <param name="apListingService"></param>
        public APListingsController(APListingService apListingService)
        {
