...
namespace MarketPlaceForYou.Repositories.Repositories.Interfaces
{
    ...
    {
        Task<List<Listing>> SearchWithFilters(string? searchString = null, string? city = null, string? category = null, string? condition = null, decimal minPrice = 0, decimal maxPrice = 0,
